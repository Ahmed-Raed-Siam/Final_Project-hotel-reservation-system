...
<nav class="main-header navbar navbar-expand navbar-white navbar-light align-items-center">
    ...
    <!-- SEARCH FORM -->
    <form class="form-inline ml-3 mt-md-auto mb-md-auto">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown user-menu m-auto">
            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                <img src="{{ asset("dist/img/user2-160x160.jpg") }}" class="user-image img-circle elevation-2" alt="User Image">
{{--                <span class="d-none d-sm-inline">Ahmed Raed Siam</span>--}}
                <span class="d-none d-sm-inline">{{ ucwords(Auth::user()->name) }}</span>
            </a>
